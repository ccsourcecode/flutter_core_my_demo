...
class _GameRouteState extends State<GameRoute> implements QuizEventListener {
  ...
  void initState() {
    ...
    // COMPLETE: Create and Load a banner ad
    BannerAd(
      adUnitId: AdHelper.bannerAdUnitId,
      request: const AdRequest(),
      size: AdSize.banner, // 320x50 banner
      // ad event listener is configured to update the UI (setState()) when an ad is loaded
  ...
  Widget? _buildFloatingActionButton() {
    ...
    return (!QuizManager.instance.isHintUsed && _rewardedAd != null)
                    ...
                    actions: [
                      ...
                      TextButton(
                        ...
                        onPressed: () {
                          Navigator.pop(context);
                          _rewardedAd?.show(
                            // It's triggered when a user becomes eligible to receive a reward
                            // (for example., finished watching a video).
        ...
        : null; // returning null hides the button from the screen.
  }
      ...
      adLoadCallback: InterstitialAdLoadCallback(
        onAdLoaded: (ad) {
          ad.fullScreenContentCallback = FullScreenContentCallback(
            // display the app's home screen when the ad is closed
  ...
  void onNewLevel(int level, Drawing drawing, String clue) {
    ...
    // request an ad when a user reaches level 3
...
// interstitial ads should be displayed between screen transitions,
// we show the interstitial ad when a user clicks the CLOSE button
  @override
