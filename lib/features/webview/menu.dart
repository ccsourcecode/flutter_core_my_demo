      ...
      builder: (context, controller) {
        return PopupMenuButton<_MenuOptions>(
          onSelected: (value) async {
            switch (value) {
              // When the user selects the Navigate to YouTube menu option, the WebViewController's loadUrl method is executed.
              // This navigation will be blocked by the navigationDelegate callback you created in the previous step.
              case _MenuOptions.navigationDelegate:
                await controller.data!.loadUrl('https://youtube.com');
                break;

              case _MenuOptions.userAgent:
                // There are two different ways to evaluate JavaScript:
                // for JavaScript code that doesn't return a value, use runJavaScript, and
                // for JavaScript code that does return a value, use runJavaScriptReturningResult.
                // executing the JavaScript expression 'navigator.userAgent'
              ...
              // Using this from the JavaScript context involves calling postMessage on the JavascriptChannel
