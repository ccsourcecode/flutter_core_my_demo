...
class DataPersistPage extends StatefulWidget {
  const DataPersistPage({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _DataPersistPageState createState() => _DataPersistPageState();
}

class _DataPersistPageState extends State<DataPersistPage> {
  fileDemo() {
    ...
    return Scaffold(
      ...
      body: Center(
        child: Column(
          children: <Widget>[
            TextButton(
              child: const Text('文件 demo'),
              onPressed: () => fileDemo(),
            ),
            TextButton(
              child: const Text('SharedPreference demo'),
              onPressed: () => spDemo(),
            ),
            TextButton(
              child: const Text('數據庫 demo'),
              onPressed: () => dbDemo(),
            )
          ],
        ),
